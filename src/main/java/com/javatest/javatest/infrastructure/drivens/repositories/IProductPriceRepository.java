...
public interface IProductPriceRepository extends JpaRepository<ProductPriceRepositoryDTO, Long> {
    ...
    List<ProductPriceRepositoryDTO> findByBrandIdAndProductIdAndDate(@Param("brandId") Integer brandId, @Param("productId") Integer productId, @Param("date") LocalDateTime date);
}
